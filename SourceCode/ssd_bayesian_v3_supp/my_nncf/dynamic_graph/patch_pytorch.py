...
from my_nncf.dynamic_graph.trace_tensor import TracedTensor, flatten_args
from my_nncf.dynamic_graph.wrappers import wrap_operator, wrap_module_call, ignore_scope
...
def get_arg_positions_to_quantize(op_name: str):
    from my_nncf.dynamic_graph.function_input_quantization import FUNCTIONS_TO_QUANTIZE
...
def patch_torch_operators():
    ...
    import torch
    from my_nncf.dynamic_graph.operator_metatypes import OPERATOR_METATYPES
