...
from my_nncf.dynamic_graph.patch_pytorch import register_operator
from my_nncf.dynamic_graph.graph_builder import ModelInputInfo, create_mock_tensor
from my_nncf.utils import is_tensor, objwalk
