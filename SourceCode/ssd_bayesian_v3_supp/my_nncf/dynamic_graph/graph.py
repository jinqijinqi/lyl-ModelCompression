...
from my_nncf.dynamic_graph.graph_matching import Expression, NodeExpression, search_all, get_edge_boundaries
from my_nncf.dynamic_graph.trace_tensor import TensorMeta, TracedTensor
from my_nncf.layers import ITERATION_MODULES

from my_nncf.nncf_logger import logger as nncf_logger
...
class InputAgnosticOperationExecutionContext:
    ...
    def from_str(s: str):
        ...
        from my_nncf.dynamic_graph.context import Scope
...
class NNCFGraph:
    ...
    def add_node(self, ia_op_exec_context: InputAgnosticOperationExecutionContext,
        ...
        from my_nncf.dynamic_graph.input_wrapping import MODEL_INPUT_OP_NAME
