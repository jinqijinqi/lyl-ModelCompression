...
import numpy as np
import torch
from examples.object_detection.my_datasets.coco import COCODataset
from examples.object_detection.my_datasets.voc0712 import VOCDetection, VOCAnnotationTransform
from examples.object_detection.my_utils.augmentations import SSDAugmentation
...
def get_training_dataset(dataset_name, path_to_annotations, path_to_imgs, config):
    ...
    input_info_list = create_input_infos(vars(config))
...
def get_testing_dataset(dataset_name, path_to_annotations, path_to_imgs, config):
    ...
    if dataset_name == 'voc':
        testing_dataset = VOCDetection(
            ...
            # path_to_imgs, [('2007', 'val')],
            './data/voc_test/VOCdevkit/', [('2007', 'test')],
            # '../../data/voc_test/VOCdevkit_debug/', [('2007', 'test')],
            transform=transform,
