...
from examples.my_common.example_logger import logger as default_logger

GENERAL_LOG_FILE_NAME = "output.log"
NNCF_LOG_FILE_NAME = "config_output.log"
...
def configure_paths(config):
    ...
    config.name = get_name(vars(config))
...
def is_pretrained_model_requested(config) -> bool:
